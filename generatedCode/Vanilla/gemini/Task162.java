...
class Task162 {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, Map<Integer, Integer>> graph2 = new HashMap<>();
         graph2.put(0, new HashMap<>());
        graph2.get(0).put(1, 1);
         graph2.put(1, new HashMap<>());
        graph2.get(1).put(2, 2);
        graph2.get(1).put(3, 3);
        ...
        graph5.get(1).put(3, 1);
        graph5.put(2, new HashMap<>());
        graph5.get(2).put(1, 3);
        graph5.get(2).put(3, 9);
        graph5.get(2).put(4, 2);
        graph5.put(3, new HashMap<>());
        graph5.get(3).put(4, 4);
        graph5.put(4, new HashMap<>());
        graph5.get(4).put(0, 7);
        graph5.get(4).put(3, 6);
