...
public class Task105 {
    ...
    public static void establishSSLConnection(String host, int port) throws UnknownHostException, NoSuchAlgorithmException, KeyManagementException, SSLHandshakeException {
