...
class Task170 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(task.countRangeSum(nums3, lower3, upper3)); // Output: 4

        int[] nums4 = {-2147483647, 0, -2147483647, 2147483647};
        int lower4 = -564, upper4 = 3864;
        System.out.println(task.countRangeSum(nums4, lower4, upper4)); // Output: 3

        int[] nums5 = {2147483647, -2147483648, 0};
        int lower5 = -1, upper5 = 0;
        System.out.println(task.countRangeSum(nums5, lower5, upper5)); // Output: 1
