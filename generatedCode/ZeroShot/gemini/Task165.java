...
public class Task165 {
    public static boolean checkFlush(String[] table, String[] hand) {
        ...
        for (String card : table) {
            char suit = card.charAt(card.indexOf("_") + 1);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkFlush(new String[]{"2_H", "5_H", "A_H", "K_H", "J_H"}, new String[]{"2_D", "3_S"})); // true
        System.out.println(checkFlush(new String[]{"A_S", "K_H", "Q_D", "J_C", "10_S"}, new String[]{"Q_S", "J_S"})); // false
