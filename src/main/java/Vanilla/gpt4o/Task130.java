...
abstract class HttpServletRequestAdapter implements HttpServletRequest {
    // Implement required methods as needed
}

    abstract class HttpServletResponseAdapter implements HttpServletResponse {
    // Implement required methods as needed
}

abstract class ServletOutputStreamAdapter extends ServletOutputStream {
