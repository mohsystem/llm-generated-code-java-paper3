...
//todo cannot find symbol method getUsername()
//cannot find symbol method getPassword()
//cannot find symbol method sendRequest(String,int,String)
//cannot find symbol method listenForRequests(int)
...
class Client {
    ...
    private void sendRequest(String serverAddress, int serverPort, String loginRequest) {
