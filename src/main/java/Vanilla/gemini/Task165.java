...
public class Task165 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkFlush(new String[]{"2_H", "5_H", "7_H", "9_H", "J_H"}, new String[]{"2_D", "5_D"})); //true
        System.out.println(checkFlush(new String[]{"A_S", "2_S", "3_S", "4_H", "5_H"}, new String[]{"6_H", "7_H"})); //false
