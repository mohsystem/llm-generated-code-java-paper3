...
public class Task107 {
    ...
    static final class MemoryContext implements Context {
        ...
        @Override public NamingEnumeration<javax.naming.NameClassPair> list(Name name) throws NamingException { throw new OperationNotSupportedException("list not supported"); }
        @Override public NamingEnumeration<javax.naming.NameClassPair> list(String name) throws NamingException { throw new OperationNotSupportedException("list not supported"); }
        @Override public NamingEnumeration<javax.naming.Binding> listBindings(Name name) throws NamingException { throw new OperationNotSupportedException("listBindings not supported"); }
        @Override public NamingEnumeration<javax.naming.Binding> listBindings(String name) throws NamingException { throw new OperationNotSupportedException("listBindings not supported"); }
        ...
        static final class NameClassPair extends javax.naming.NameClassPair {
    ...
    public static void main(String[] args) throws Exception {
        ...
        safeBind(ctx, "kv/store", new ConcurrentHashMap<String, String>(), allowList);
