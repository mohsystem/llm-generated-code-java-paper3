...
public class Task149 {
    ...
    //todo cannot find symbol method enqueue(Queue,int)
    //cannot find symbol method enqueue(Queue,int)
    //cannot find symbol method enqueue(Queue,int)
    //cannot find symbol method dequeue(Queue)
    //cannot find symbol method peek(Queue)
    //cannot find symbol method enqueue(Queue,int)
    //cannot find symbol method dequeue(Queue)
    //cannot find symbol method dequeue(Queue)
    //cannot find symbol method dequeue(Queue)
