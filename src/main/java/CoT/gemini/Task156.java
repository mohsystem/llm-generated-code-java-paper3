...
public class Task156 {
    ...
    public List<Integer> preorderTraversal(Node5 root) {
        List<Integer> result = new ArrayList<>();
        preorder(root, result);
        return result;
    }

    private void preorder(Node5 node, List<Integer> result) {
        if (node != null) {
    ...
    public List<Integer> inorderTraversal(Node5 root) {
        List<Integer> result = new ArrayList<>();
        inorder(root, result);
        return result;
    }

    private void inorder(Node5 node, List<Integer> result) {
        if (node != null) {
    ...
    public List<Integer> postorderTraversal(Node5 root) {
        List<Integer> result = new ArrayList<>();
        postorder(root, result);
        return result;
    }

    private void postorder(Node5 node, List<Integer> result) {
        if (node != null) {
    ...
    public static void main(String[] args) {
        ...
        // Test case 1
        Node5 root1 = new Node5(1);
        root1.right = new Node5(2);
        root1.right.left = new Node5(3);
