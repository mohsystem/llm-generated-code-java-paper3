...
public class Task86 {
    ...
    public static void downloadAndExecute(String urlStr) throws IOException {
        ...
        //todo incompatible types: boolean cannot be converted to Set<PosixFilePermission>
        Set<PosixFilePermission> posixFilePermissions = Files.getPosixFilePermissions(targetPath);
